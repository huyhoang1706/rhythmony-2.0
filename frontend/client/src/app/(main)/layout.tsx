...
export default async function MainLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <div className="flex h-screen min-w-[800px] flex-col">
      <Header />
      <div className="h-[calc(100vh-51px)] bg-neutral-900 px-2 pb-2">
        <div className="mb-2 h-[calc(100%-80px)]">
          <ResizeLayout defaultLayout={defaultLayout}>
            <main className="custom-scroll-bar relative h-full w-full overflow-y-auto rounded-lg bg-gradient-to-b from-neutral-700/40 p-2">
