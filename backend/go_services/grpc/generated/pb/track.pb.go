...
type ListTracksByAlbumIdRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListTracksByAlbumIdRequest) Reset() {
	*x = ListTracksByAlbumIdRequest{}
	mi := &file_track_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListTracksByAlbumIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTracksByAlbumIdRequest) ProtoMessage() {}

func (x *ListTracksByAlbumIdRequest) ProtoReflect() protoreflect.Message {
	mi := &file_track_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTracksByAlbumIdRequest.ProtoReflect.Descriptor instead.
func (*ListTracksByAlbumIdRequest) Descriptor() ([]byte, []int) {
	return file_track_proto_rawDescGZIP(), []int{10}
}

func (x *ListTracksByAlbumIdRequest) GetAlbumId() string {
	if x != nil {
		return x.AlbumId
	}
	return ""
...
type ListTracksByAlbumIdResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListTracksByAlbumIdResponse) Reset() {
	*x = ListTracksByAlbumIdResponse{}
	mi := &file_track_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListTracksByAlbumIdResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTracksByAlbumIdResponse) ProtoMessage() {}

func (x *ListTracksByAlbumIdResponse) ProtoReflect() protoreflect.Message {
	mi := &file_track_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTracksByAlbumIdResponse.ProtoReflect.Descriptor instead.
func (*ListTracksByAlbumIdResponse) Descriptor() ([]byte, []int) {
	return file_track_proto_rawDescGZIP(), []int{11}
}

func (x *ListTracksByAlbumIdResponse) GetTracks() []*Track {
	if x != nil {
		return x.Tracks
	}
	return nil
...
type ListSeveralTracksByArtistIdRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	PageNo   uint64 `protobuf:"varint,3,opt,name=page_no,json=pageNo,proto3" json:"page_no,omitempty"`
}

func (x *ListSeveralTracksByArtistIdRequest) Reset() {
	*x = ListSeveralTracksByArtistIdRequest{}
	mi := &file_track_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListSeveralTracksByArtistIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListSeveralTracksByArtistIdRequest) ProtoMessage() {}

func (x *ListSeveralTracksByArtistIdRequest) ProtoReflect() protoreflect.Message {
	mi := &file_track_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListSeveralTracksByArtistIdRequest.ProtoReflect.Descriptor instead.
func (*ListSeveralTracksByArtistIdRequest) Descriptor() ([]byte, []int) {
	return file_track_proto_rawDescGZIP(), []int{12}
}

func (x *ListSeveralTracksByArtistIdRequest) GetArtistId() string {
	if x != nil {
		return x.ArtistId
	}
	return ""
...
func (x *ListSeveralTracksByArtistIdRequest) GetPageSize() uint64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListSeveralTracksByArtistIdRequest) GetPageNo() uint64 {
	if x != nil {
		return x.PageNo
	}
	return 0
...
type ListSeveralTracksByArtistIdResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TotalPages    uint64   `protobuf:"varint,3,opt,name=total_pages,json=totalPages,proto3" json:"total_pages,omitempty"`
	TotalElements uint64   `protobuf:"varint,4,opt,name=total_elements,json=totalElements,proto3" json:"total_elements,omitempty"`
	Track         []*Track `protobuf:"bytes,5,rep,name=track,proto3" json:"track,omitempty"`
}

func (x *ListSeveralTracksByArtistIdResponse) Reset() {
	*x = ListSeveralTracksByArtistIdResponse{}
	mi := &file_track_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListSeveralTracksByArtistIdResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListSeveralTracksByArtistIdResponse) ProtoMessage() {}

func (x *ListSeveralTracksByArtistIdResponse) ProtoReflect() protoreflect.Message {
	mi := &file_track_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListSeveralTracksByArtistIdResponse.ProtoReflect.Descriptor instead.
func (*ListSeveralTracksByArtistIdResponse) Descriptor() ([]byte, []int) {
	return file_track_proto_rawDescGZIP(), []int{13}
}

func (x *ListSeveralTracksByArtistIdResponse) GetPageSize() uint64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListSeveralTracksByArtistIdResponse) GetPageNo() uint64 {
	if x != nil {
		return x.PageNo
	}
	return 0
...
func (x *ListSeveralTracksByArtistIdResponse) GetTotalPages() uint64 {
	if x != nil {
		return x.TotalPages
	}
	return 0
...
func (x *ListSeveralTracksByArtistIdResponse) GetTotalElements() uint64 {
	if x != nil {
		return x.TotalElements
	}
	return 0
...
func (x *ListSeveralTracksByArtistIdResponse) GetTrack() []*Track {
	if x != nil {
		return x.Track
	}
	return nil
...
var file_track_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x37, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x54,
	0x72, 0x61, 0x63, 0x6b, 0x73, 0x42, 0x79, 0x41, 0x6c, 0x62, 0x75, 0x6d, 0x49, 0x64, 0x52, 0x65,
	...
	0x22, 0x50, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x42, 0x79,
	0x41, 0x6c, 0x62, 0x75, 0x6d, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x31, 0x0a, 0x06, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x19, 0x2e, 0x72, 0x68, 0x79, 0x74, 0x68, 0x6d, 0x6f, 0x6e, 0x79, 0x2e, 0x6d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x52, 0x06, 0x74, 0x72, 0x61, 0x63,
	0x6b, 0x73, 0x22, 0x77, 0x0a, 0x22, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x76, 0x65, 0x72, 0x61,
	0x6c, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x42, 0x79, 0x41, 0x72, 0x74, 0x69, 0x73, 0x74, 0x49,
	...
	0x7a, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x6f, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x06, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x6f, 0x22, 0xd4, 0x01, 0x0a, 0x23,
	0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x76, 0x65, 0x72, 0x61, 0x6c, 0x54, 0x72, 0x61, 0x63, 0x6b,
	0x73, 0x42, 0x79, 0x41, 0x72, 0x74, 0x69, 0x73, 0x74, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x04, 0x52, 0x06, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x6f, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6f, 0x74,
	...
	,
...
var file_track_proto_goTypes = []any{
	...
	(*ListTracksByAlbumIdRequest)(nil),          // 10: rhythmony.metadata.ListTracksByAlbumIdRequest
	(*ListTracksByAlbumIdResponse)(nil),         // 11: rhythmony.metadata.ListTracksByAlbumIdResponse
	(*ListSeveralTracksByArtistIdRequest)(nil),  // 12: rhythmony.metadata.ListSeveralTracksByArtistIdRequest
	(*ListSeveralTracksByArtistIdResponse)(nil), // 13: rhythmony.metadata.ListSeveralTracksByArtistIdResponse
	(*Track)(nil),                               // 14: rhythmony.metadata.Track
}
var file_track_proto_depIdxs = []int32{
	14, // 0: rhythmony.metadata.GetTrackByIdResponse.track:type_name -> rhythmony.metadata.Track
	14, // 1: rhythmony.metadata.ListSeveralTracksResponse.tracks:type_name -> rhythmony.metadata.Track
	14, // 2: rhythmony.metadata.CreateTrackResponse.track:type_name -> rhythmony.metadata.Track
	14, // 3: rhythmony.metadata.UpdateTrackResponse.track:type_name -> rhythmony.metadata.Track
	14, // 4: rhythmony.metadata.ListTracksByAlbumIdResponse.tracks:type_name -> rhythmony.metadata.Track
	14, // 5: rhythmony.metadata.ListSeveralTracksByArtistIdResponse.track:type_name -> rhythmony.metadata.Track
	0,  // 6: rhythmony.metadata.TrackAPI.GetTrackById:input_type -> rhythmony.metadata.GetTrackByIdRequest
	2,  // 7: rhythmony.metadata.TrackAPI.ListSeveralTracks:input_type -> rhythmony.metadata.ListSeveralTracksRequest
	4,  // 8: rhythmony.metadata.TrackAPI.CreateTrack:input_type -> rhythmony.metadata.CreateTrackRequest
	6,  // 9: rhythmony.metadata.TrackAPI.UpdateTrack:input_type -> rhythmony.metadata.UpdateTrackRequest
	8,  // 10: rhythmony.metadata.TrackAPI.DeleteTrack:input_type -> rhythmony.metadata.DeleteTrackRequest
	10, // 11: rhythmony.metadata.TrackAPI.ListTracksByAlbumId:input_type -> rhythmony.metadata.ListTracksByAlbumIdRequest
	12, // 12: rhythmony.metadata.TrackAPI.ListSeveralTracksByArtistId:input_type -> rhythmony.metadata.ListSeveralTracksByArtistIdRequest
	1,  // 13: rhythmony.metadata.TrackAPI.GetTrackById:output_type -> rhythmony.metadata.GetTrackByIdResponse
	3,  // 14: rhythmony.metadata.TrackAPI.ListSeveralTracks:output_type -> rhythmony.metadata.ListSeveralTracksResponse
	5,  // 15: rhythmony.metadata.TrackAPI.CreateTrack:output_type -> rhythmony.metadata.CreateTrackResponse
	7,  // 16: rhythmony.metadata.TrackAPI.UpdateTrack:output_type -> rhythmony.metadata.UpdateTrackResponse
	9,  // 17: rhythmony.metadata.TrackAPI.DeleteTrack:output_type -> rhythmony.metadata.DeleteTrackResponse
	11, // 18: rhythmony.metadata.TrackAPI.ListTracksByAlbumId:output_type -> rhythmony.metadata.ListTracksByAlbumIdResponse
	13, // 19: rhythmony.metadata.TrackAPI.ListSeveralTracksByArtistId:output_type -> rhythmony.metadata.ListSeveralTracksByArtistIdResponse
