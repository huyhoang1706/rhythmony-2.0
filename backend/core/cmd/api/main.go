...
import (
	...
	"net/http"
	"os"
	"rhythmony/core/internal/application/services"
	"rhythmony/core/internal/domain/entities"
	"rhythmony/core/internal/infrastructure"
...
func StartGRPCServer(
	lc fx.Lifecycle, server *grpc.Server,
	logger *zap.Logger,
	genreServiceServer pb.GenreServiceServer) *grpc.Server {
	...
	lc.Append(fx.Hook{
		OnStart: func(ctx context.Context) error {
			...
			pb.RegisterGenreServiceServer(server, genreServiceServer)
